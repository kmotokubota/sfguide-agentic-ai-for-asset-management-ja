...
Simulated Asset Management implements comprehensive concentration risk limits to protect client portfolios from excessive exposure to individual issuers, sectors, geographies, and asset classes. This policy establishes mandatory concentration thresholds that trigger monitoring, review, and remediation actions.
...
**Scope**: All discretionary investment portfolios managed by Simulated Asset Management.
...
*This policy represents Simulated Asset Management's commitment to prudent concentration risk management. All personnel managing client assets must understand and adhere to these concentration limits.*
